...
//    public static final String key = "abcdefghig123456";//16位key aes 加密
    public static final String key = com.zlp.platform.core.ConfigContext.getConfigMap().get(ZlpState.AES_SECRET_KEY)==null?"":com.zlp.platform.core.ConfigContext.getConfigMap().get(ZlpState.AES_SECRET_KEY);
    ...
    public static String encrypt(String content, String key) {
        try {
            ...
            return  new String(Base64.encodeBase64(encode_content),"utf-8"); //将加密后的数据转换为字符串返回
        } catch (Exception e) {
            e.printStackTrace();
            return null;
        }
    ...
    public static String decrypt(String encryptStr, String decryptKey) {
        try {
            ...
            byte [] encode_content = Base64.decodeBase64(encryptStr.getBytes("utf-8")); //把密文字符串转回密文字节数组
